...
const { adminRouter: pageBuilderAdminRouter, publicRouter: pageLayoutPublicRouter } = require('./routes/pageBuilder');
...
app.use('/api/admin/page-builder', pageBuilderAdminRouter);
app.use('/api/page-layout', pageLayoutPublicRouter);
