...
const { isConfigured: merchantConfigured } = require('../services/merchantCenter');

// The Advisor. The SEO/Merchant health panel answers "is anything broken?";
// this answers "what should I do next to grow?". It reads the catalogue,
// reviews, journal and last site audit and turns them into a short, prioritised
// to-do list — each item with a plain-language WHY and a concrete ACTION.
//
// DB-driven and cached, so it stays fast and doesn't re-hit Google's APIs (the
// health panel already surfaces live Merchant disapprovals). Priorities:
