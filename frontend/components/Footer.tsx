...
// Minimal inline SVGs for footer social icons
const FOOTER_ICONS: Record<string, JSX.Element> = {
  ...
  threads: <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.852 1.206 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.589 12c.027 3.086.718 5.496 2.057 7.164 1.43 1.783 3.631 2.698 6.54 2.717 2.623-.02 4.358-.631 5.689-2.042 1.47-1.56 1.875-3.854 1.678-5.503h-5.33c-.048 1.596-.536 2.699-1.434 3.348-1.03.75-2.445.846-4.026.725-1.504-.118-2.684-.773-3.321-1.817-.507-.821-.589-1.822-.344-2.838.39-1.62 1.737-2.681 3.638-2.888 1.166-.125 2.485.1 3.755.525z"/></svg>,
  ...
  twitter_x: <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.748l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>,
};
  ...
  return (
    <footer className={styles.footer}>
      ...
      {socialPlatforms.length > 0 && (
        <div style={{ display: 'flex', gap: 20, padding: '0 6% 28px', alignItems: 'center' }}>
